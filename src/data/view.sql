...
select id_tp,id_utilisateur,parcelle.id_parcelle,id_terrain,categorie_culture.id_categorie,id_type,rendement_par_pieds,prix_unitaire,dimension,nb_pieds,prix as prix_parcelle 
...
select id_terrain,id_parcelle,id_utilisateur,(dimension * 4) as nb_pieds,((dimension * 4)*prix_unitaire)as montant,id_categorie,id_type from v_information_parcelle
...
select id_terrain,id_parcelle,id_utilisateur,(dimension * 6) as nb_pieds,((dimension * 6)*prix_unitaire)as montant,id_categorie 
